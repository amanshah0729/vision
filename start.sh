...
#
# No --tunnel flag here on purpose: put it behind whatever gives you HTTPS (a Cloudflare
# named tunnel, a reverse proxy…). The glasses browser refuses plain http and the phone
# needs a public URL to dial out to.
#
